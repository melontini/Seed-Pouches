...
public class EntityRegistry {
    ...
    public static final EntityType<SaplingPouchEntity> SAPLING_POUCH_ENTITY = FabricEntityTypeBuilder.<SaplingPouchEntity>create(SpawnGroup.MISC, SaplingPouchEntity::new)
            .dimensions(EntityDimensions.fixed(0.25F, 0.25F))
            .trackRangeBlocks(4).trackedUpdateRate(10)
            .build();
